...
import { DeviceUserDocument } from '@repo/common/models/device-user.schema';
import { Trash2, X } from 'lucide-react';
import React, { useState } from 'react';

interface DeleteButtonProps {
    deviceUserData: DeviceUserDocument;
    submitHandler: (deviceUserData: DeviceUserDocument) => Promise<void>;
}
