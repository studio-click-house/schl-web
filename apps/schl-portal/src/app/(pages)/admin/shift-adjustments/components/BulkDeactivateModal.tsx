                ...
                <div className="p-4">
                    <div className="bg-red-50 p-4 rounded-md border border-red-200 mb-4 flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-red-800 text-sm font-semibold mb-1">
                                Warning: Deactivating {selectedCount} Adjustment
                                {selectedCount !== 1 ? 's' : ''}
                            </p>
                            <p className="text-red-700 text-sm">
                                This will disable these adjustments. This action
                                cannot be undone.
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        <label className="tracking-wide text-gray-700 text-sm font-bold block mb-2">
                            <span className="uppercase">Reason / Comment</span>
                        </label>
                        <textarea
                            value={comment}
